...
//    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnsubmit) {
            if (!(edtAge.getText().toString().trim().equals("") || edtName.getText().toString().trim().equals(""))) {
                DatabaseHelper db = new DatabaseHelper(context);
                ...
                Toast.makeText(context,"Harap isi data terlebih dahulu", Toast.LENGTH_LONG).show();
            }
        }
    }
